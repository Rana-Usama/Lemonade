...
function CheckPriceScreen(props) {

    const data = [
        {
            imageSource: require('../../assets/images/co1.png'),
            title1: 'Diagonistic &',
            title2: 'medication'
        },
        {
            imageSource: require('../../assets/images/co2.png'),
            title1: 'Procedure &',
            title2: 'Hospitalization'
        },
        {
            imageSource: require('../../assets/images/co3.png'),
            title1: 'Preventive',
            title2: 'care'
        },
    ]
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                    ...
                    <View style={styles.startingFromContainer} >
                        ...
                        <Text style={{ marginLeft: RFPercentage(0.5), color: Colors.greyNew, fontSize: RFPercentage(1.9) }} >
                            Upto 10% bundle discount
                        </Text>
                    </View>

                    <View style={{ marginTop: RFPercentage(1.2), width: '90%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', alignSelf: 'center' }} >
                        <View style={styles.pinkBox} >
                            <Octicons name="check" style={{ fontSize: RFPercentage(1.4) }} color={Colors.white} />
                        </View>
                        <Text style={{ marginLeft: RFPercentage(0.5), color: Colors.greyNew, fontSize: RFPercentage(1.9) }} >
